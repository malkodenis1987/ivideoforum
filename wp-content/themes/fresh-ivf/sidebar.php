<div class="sidebar-wrap">
    ...
    <div id="sidebar" class="long">
        <div id="sidebar-adwert">
            <?php  include (TEMPLATEPATH . '/adv-sidebar.php'); ?>
        </div>
        ...
        <a class="rss" href="<?php bloginfo('rss2_url'); ?>" title="<?php _e('Syndicate this site using RSS'); ?>">RSS Articles</a>
        <div id="latestpost">
    ...
    <div id="buttons">
        ...
        <div style="width: 100px; height: 66px; float: left; margin-bottom: 15px;">
