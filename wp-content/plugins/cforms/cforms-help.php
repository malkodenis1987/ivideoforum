...
<img src="<?php echo $cforms_root; ?>/images/cfii.gif" alt="" align="right"/><img src="<?php echo $cforms_root; ?>/images/p4-title.jpg" alt=""/>
		...
		<ul class="cftoc">
			...
			<li><a href="#customerr" onclick="setshow(20)"><?php _e('Custom error messages &amp; titles', 'cforms'); ?></a> &raquo;</li>
...
[...]<br />
	    ...
	    <h3 id="customerr"><a class="helptop" href="#top"><?php _e('top', 'cforms'); ?></a><a id="b20" class="blindminus" onfocus="this.blur()" onclick="toggleui(20);return false;" href="#" title="<?php _e('Expand/Collapse', 'cforms') ?>"></a><span class="h3title-no">4.</span><?php _e('Custom error messages &amp; titles', 'cforms'); ?></h3>
