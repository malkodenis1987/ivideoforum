...
$cforms_root = get_option('siteurl') . '/wp-content/plugins/'.$plugindir;
						...
						<div id="f<?php echo $i; ?>" class="groupItem<?php echo $alternate; ?>">
							...
							<div class="itemContent">
								...
								<input title="<?php _e('Please enter field definition', 'cforms'); ?>" class="inpfld" <?php echo $specialclass; ?> name="field_<?php echo($i); ?>_name" id="field_<?php echo($i); ?>_name" size="30" value="<?php echo ($field_type == 'fieldsetend')?'--':$field_name; ?>" /><a href="#" class="jqModal" title="<?php echo $cforms_root.'/js/include/'; ?>"><img class="wrench" src="<?php echo $cforms_root; ?>/images/wrench.gif" alt="<?php _e('edit', 'cforms'); ?>" title="<?php _e('edit', 'cforms'); ?>"/></a><select title="<?php _e('Pick a field type', 'cforms'); ?>" class="fieldtype selfld" <?php echo $specialclass; ?> name="field_<?php echo($i); ?>_type" id="field_<?php echo($i); ?>_type">
									...
									<option<?php if ( get_option('cforms_datepicker')<>'1' ) echo ' disabled="disabled" class="disabled"'; ?> value="datepicker" <?php echo($field_type == 'datepicker'?' selected="selected"':''); ?>>&nbsp;&nbsp;<?php _e('Date Entry/Dialog', 'cforms'); ?></option>
									...
									<?php if ( substr(get_option('cforms'.$no.'_tellafriend'),0,1)<>'1' ) $dis=' disabled="disabled" class="disabled"'; else $dis=''; ?>
									...
									<?php if ( substr(get_option('cforms'.$no.'_tellafriend'),0,1)<>'2' ) $dis=' disabled="disabled" class="disabled"'; else $dis=''; ?>
	...
	<fieldset id="fileupload" class="cformsoptions <?php if( !$fileupload) echo "hidden"; ?>">
		...
		<fieldset class="cformsoptions" id="commentrep">
			...
			<div id="o7">
				...
				<div class="optionsbox">
					<div class="optionsboxL"></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_commentrep" name="cforms_commentrep" <?php if( substr(get_option('cforms'.$no.'_tellafriend'),0,1)=='2' ) echo "checked=\"checked\""; ?>/><label for="cforms_commentrep"><strong><?php _e('Enable this form to optionally (user determined) act as a WP comment form', 'cforms') ?></strong></label></div>
				</div>
				<div class="optionsbox">
					<div class="optionsboxL"></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_commentXnote" name="cforms_commentXnote" <?php if( substr(get_option('cforms'.$no.'_tellafriend'),1,1)=='1' ) echo "checked=\"checked\""; ?>/><label for="cforms_commentXnote"><strong><?php _e('Extra comment notification (check your autoresponder setting, too!)', 'cforms') ?></strong></label>
						<?php if( substr(get_option('cforms'.$no.'_tellafriend'),0,1)=='2' ) : ?>
							<br />
