...
//	update_option('cforms_linklove', $_REQUEST['cforms_linklove']?'1':'0');
	...
	$captcha['i'] = $_REQUEST['cforms_cap_i'];
		...
		<fieldset id="captcha" class="cformsoptions">
			...
			<div id="o26">						   
				...
				<div class="optionsbox" style="margin-top:10px;">
					...
					<div class="optionsboxL"></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_cap_i" name="cforms_cap_i" value="i" <?php if($captcha['i']=='i') echo "checked=\"checked\""; ?>/><label for="cforms_cap_i"><?php _e('User response is treated case insensitive', 'cforms') ?></label></div>
				</div>
...
function cf_get_files($dir,$currentfile,$ext){
	...
	$fullplugindir	= ABSPATH . 'wp-content/plugins/' . basename(dirname(__FILE__));
	$presetsdir		= $fullplugindir.'/../cforms-custom';
	$list 			= '';
	$allfiles		= array();
