 ...
 * @var $layout
 * Shortcode class
 * @var $this WPBakeryShortCode_Cth_Paypal_Registration
 */
...
if ($eventres_test_mode == true) {
    $paypal_url = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
}else{
    $paypal_url = 'https://www.paypal.com/cgi-bin/webscr';
}
//echo'<pre>';var_dump($eventres_item_quantity);die;
...
<?php endif;?>
                ...
                <?php endif;?>
                    ...
                    <form action="<?php echo esc_url($paypal_url );?>" method="POST" target="_top" id="paypal-regn">
                        ...
                        <?php
                            ...
                            if ( function_exists( 'wp_nonce_field' ) ) 
                                wp_nonce_field( 'gather_event_paypal_registration_action', 'gather_event_paypal_registration_nonce' );
                        ?>
                        <div class="row">
                            <div class="col-sm-6">
