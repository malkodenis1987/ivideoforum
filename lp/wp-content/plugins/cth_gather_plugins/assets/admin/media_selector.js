...
jQuery('.upload_image_button').on('click', function(event) {
    ...
    file_frame.on('select', function() {
        ...
        jQuery("input[id='"+field_key+"[id]"+"']").val(attachment.id);
        jQuery("input[id='"+field_key+"[url]"+"']").val(attachment.url);
        jQuery("img[id='"+field_key+"[preview]"+"']").attr('src',attachment.url).css('display','block');
...
jQuery('.remove_image_button').on('click', function(event) {
    ...
    jQuery("input[id='"+field_key+"[id]"+"']").val('');
    jQuery("input[id='"+field_key+"[url]"+"']").val('');
    jQuery("img[id='"+field_key+"[preview]"+"']").attr('src','').css('display','none');
