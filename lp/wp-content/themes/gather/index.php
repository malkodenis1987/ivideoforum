...
<header id="top" class="sub-header">
    <div class="container">
        ...
        <h3 class="page-title wow fadeInDown"><?php echo esc_attr($cththemes_options['blog_home_text'] ) ;?> <small><?php echo esc_attr($cththemes_options['blog_home_text_intro'] );?></small></h3>
