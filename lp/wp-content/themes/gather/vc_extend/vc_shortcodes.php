...
if(function_exists('vc_map')){
    ...
    vc_map( array(
        "name"      => __("Google Map", 'domik'),
        "description" => __("Google Map",'domik'),
        "base"      => "domik_gmap",
        "class"     => "",
        ...
        "params"    => array(
            array(
                ...
                "class"     => "",
                "holder"     => "span",
                "heading"   => __("Address Latitude", 'domik'),
                "param_name"=> "latitude",
                "value"     => "59.3292956",
                "description" => __("Enter your address latitude. You can get your value from: <a href='http://www.gps-coordinates.net/' target='_blank'>http://www.gps-coordinates.net/</a>", 'domik')
            ),
            array(
                "type"      => "textfield",
                "class"     => "",
                "holder"     => "span",
                "heading"   => __("Address Longitude", 'domik'),
                "param_name"=> "longitude",
                "value"     => "18.0686451",
                "description" => __("Enter your address longitude. You can get your value from: <a href='http://www.gps-coordinates.net/' target='_blank'>http://www.gps-coordinates.net/</a>", 'domik')
            ),
            array(
                "type"      => "textfield",
                "class"     => "",
                "holder"     => "span",
                "heading"   => __("Address String", 'domik'),
                "param_name"=> "address",
                "value"     => "Stockholm, Sweden",
                "description" => __("Address string", 'domik')
            ),
            array(
                "type"      => "textfield",
                "class"     => "",
                //"holder"     => "span",
                "heading"   => __("Zoom", 'domik'),
                "param_name"=> "zoom",
                "value"     => "2",
                "description" => __("", 'domik')
            ),
            array(
                "type"      => "attach_image",
                "class"     => "",
                "heading"   => __("Marker", 'domik'),
                "param_name"=> "marker",
                "value"     => get_template_directory_uri() ."/images/marker.png",
                "description" => __("Upload google map marker or leave it empty to use default.", 'domik')
            ),
            array(
                "type"      => "textfield",
                "class"     => "",
                //"holder"     => "span",
                "heading"   => __("Map Height", 'domik'),
            ...
            array(
                "type" => "dropdown",
                "class"=>"",
                "heading" => __('Color', 'domik'),
                "param_name" => "colorbg",
                "value" => array(   
                    __('Green', 'domik') => 'green',  
                    __('Red', 'domik') => 'red',  
                    __('Orange', 'domik') => 'orange',       
                    __('Yellow', 'domik') => 'yellow',  
                    __('Mint', 'domik') => 'mint',  
                    __('Aqua', 'domik') => 'aqua',  
                    __('Blue', 'domik') => 'blue',  
                    __('Purple', 'domik') => 'purple',  
                    __('Pink', 'domik') => 'pink',  
                    __('White', 'domik') => 'white',  
                    __('Grey', 'domik') => 'grey',  
                    __('Black', 'domik') => 'black',  
                    __('Invert', 'domik') => 'invert',  
                ),
                //"description" => __("", 'domik'),  
                "default"=>'green',    
            ),
        ...
        "params" => array(
            array(
                ...
                "value" => array(   
                                ...
                                __('27', 'gather') => '27',   
                                __('28', 'gather') => '28',   
                                __('29', 'gather') => '29 (not all months)',   
                                __('30', 'gather') => '30 (not all months)',   
                                __('31', 'gather') => '31 (not all months)',   
                                                                                                              
                            ),
                "description" => __("Set countdown date", "wpb"), 
            ),
            ...
            array(
                ...
                "description" => __("Set countdown month", "wpb"), 
            ),
            array(
                "type" => "dropdown",
                "class"=>"",
                ...
                "description" => __("Set countdown year", "wpb"), 
            ),
            array(
                "type"      => "textfield",
                "class"     => "",
    ...
    vc_map( array(
        "name"      => __("Direction", 'domik'),
        "description" => __("Google direction",'domik'),
        "base"      => "cth_directions",
        "class"     => "",
        "icon" => get_template_directory_uri() . "/vc_extend/cth-icon.png",
        "category"  => 'Gather',
    ...
    vc_map( array(
        "name"      => __("MailChimp Subscribe", 'domik'),
        "description" => __("MailChimp Subscribe",'domik'),
        "base"      => "cth_mailchimp",
        "class"     => "",
        "icon" => get_template_directory_uri() . "/vc_extend/cth-icon.png",
        "category"  => 'Gather',
    ...
    vc_map( array(
        "name"      => __("Our Sponsors", 'domik'),
        "description" => __("Our Sponsors",'domik'),
        "base"      => "cth_sponsors",
        "class"     => "",
        "icon" => get_template_directory_uri() . "/vc_extend/cth-icon.png",
        "category"  => 'Gather',
    ...
    vc_map( array(
        "name"      => __("Our Speakers", 'domik'),
        "description" => __("Our Speakers",'domik'),
        "base"      => "cth_speakers",
        "category"  => 'Gather',
    ...
    if(function_exists('vc_map')){
       ...
       "params"    => array(
          ...
          array(
             ...
             "description" => __("Search icon : <a href='http://themes-pixeden.com/font-demos/7-stroke/' target='_blank'>StreamLine Icons</a>", 'gather')
          ),
          array(
             "type"      => "textfield",
             "holder"    => "div",
   ...
   vc_map( array(
       ...
       "params"    => array(
          ...
          array(
                ...
                "class"     => "",
                "holder"     => "span",
                "heading"   => __("Event Address Latitude", 'domik'),
                "param_name"=> "latitude",
                "value"     => "59.3292956",
                "description" => __("Enter your address latitude. You can get your value from: <a href='http://www.gps-coordinates.net/' target='_blank'>http://www.gps-coordinates.net/</a>", 'domik')
            ),
            array(
                ...
                "class"     => "",
                "holder"     => "span",
                "heading"   => __("Event Address Longitude", 'domik'),
                "param_name"=> "longitude",
                "value"     => "18.0686451",
                "description" => __("Enter your address longitude. You can get your value from: <a href='http://www.gps-coordinates.net/' target='_blank'>http://www.gps-coordinates.net/</a>", 'domik')
            ),
            ...
            array(
                ...
                "class"     => "",
                //"holder"     => "span",
                "heading"   => __("Search Distance", 'domik'),
                "param_name"=> "distance",
                "value"     => "1500",
                "description" => __("Defines the distance (in meters) within which to return place results. The maximum allowed radius is 50 000 meters.", 'domik')
            ),
            array(
                "type"      => "textfield",
                "class"     => "",
                //"holder"     => "span",
                "heading"   => __("Search Types", 'domik'),
                "param_name"=> "types",
    ...
    vc_map( array(
       "name"      => __("Latest Posts", 'domik'),
       "description" => __("Grid of latest posts",'domik'),
    ...
    vc_map( array(
        "name"      => __("Carousel Slider", 'domik'),
        "description" => __("Carousel with slick slider plugin",'domik'),
