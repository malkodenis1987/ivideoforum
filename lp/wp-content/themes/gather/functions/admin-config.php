<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Gather Options', 'gather' ),
        'page_title'           => __( 'Gather Options', 'gather' ),
    ...
    Redux::setSection( $opt_name, array(
        'title' => __('General Settings', 'gather'),
        'id'         => 'general-settings',
        'subsection' => false,
        //'desc'       => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="http://docs.reduxframework.com/core/fields/checkbox/" target="_blank">http://docs.reduxframework.com/core/fields/checkbox/</a>',
        'icon'       => 'el-icon-cogs',
        'fields' => array(
            ...
            array(
                'id' => 'logo_size_width',
                'type' => 'text',
                'title' => __('Logo Size Width', 'gather'),
                'subtitle' => __('', 'gather'),
                'desc' => __('', 'gather'),
                'default' => '108'
            ),
            array(
                'id' => 'logo_size_height',
                'type' => 'text',
                'title' => __('Logo Size Height', 'gather'),
                'subtitle' => __('', 'gather'),
                'desc' => __('', 'gather'),
                'default' => '36'
            ),
            ...
            array(
                'id' => 'seo_des',
                'type' => 'textarea',
                'title' => __('SEO Description', 'gather'),
                'subtitle' => __('', 'gather'),
                'desc' => __('', 'gather'),
                'default' => ''
            ),
    ...
    Redux::setSection( $opt_name, array(
        'title' => __('Footer Settings', 'gather'),
        'id'         => 'footer-settings',
        'subsection' => false,
        //'desc'       => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="http://docs.reduxframework.com/core/fields/checkbox/" target="_blank">http://docs.reduxframework.com/core/fields/checkbox/</a>',
        'icon'       => 'el-icon-pencil',
...
<div class="social-icons">
    ...
    Redux::setSection( $opt_name, array(
        'title' => __('Styling Options', 'gather'),
        'id'         => 'styling-settings',
        'subsection' => false,
        //'desc'       => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="http://docs.reduxframework.com/core/fields/checkbox/" target="_blank">http://docs.reduxframework.com/core/fields/checkbox/</a>',
        'icon'       => 'el-icon-magic',
